<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StudentAttendanceUC.ascx.cs" Inherits="SchoolManagementSystem.StudentAttendanceUC" %>
    ...
    <div style="background-image:url('../Images/bg.jpg'); width:100%; height: 1080px; background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
        <div class="container-fluid">
            ...
            <h3 class="text-center">Student' attendance detail</h3>
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
                <div class="col-md-6">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Class is required."
                                                ControlToValidate="ddlClass" Display="Dynamic" ForeColor="Red" SetFocusOnError="True">
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
                <div class="col-md-6">
                    ...
                    <asp:TextBox ID="txtRollNo" runat="server" CssClass="form-control" placeholder="Enter student's roll number"></asp:TextBox>
