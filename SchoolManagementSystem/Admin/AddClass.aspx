    ...
    <div style="background-image:url('../Images/bg.jpg'); width:100%; height: 1080px; background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
        <div class="container p-md-4 p-sm-4">
            ...
            <div class ="row mb-3 mr-lg-5 ml-lg-5">
                <div class="col-md-6">
                    <asp:GridView AutoGenerateColumns="False" CssClass="table table-hover table-bordered" DataKeyNames="ClassId" 
                                  EmptyDataText="No record to display." ID="GridView1" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCancelingEdit="GridView1_RowCancelingEdit" 
                                  OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" AllowPaging="True" PageSize="4" runat="server">
                        <Columns>
